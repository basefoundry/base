...
```bash
basectl release check --version 1.0.5
basectl release plan --version 1.0.5
basectl release notes --version 1.0.5
basectl release publish --version 1.0.5 --dry-run
basectl release publish --version 1.0.5 --yes
```
...
Base `1.0.5` is the current release. The implemented command surface covers
...
status/check/doctor reports, local AI context exports, external reusable Bash
