...
```bash
basectl release check --version 1.0.0
basectl release plan --version 1.0.0
basectl release notes --version 1.0.0
basectl release publish --version 1.0.0 --dry-run
basectl release publish --version 1.0.0 --yes
```
...
Base `1.0.0` is the current release. The implemented command surface covers
...
status/check/doctor reports, local AI context exports, and explicit prerequisite
