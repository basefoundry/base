...
```bash
basectl release check --version 0.4.4
basectl release plan --version 0.4.4
basectl release notes --version 0.4.4
basectl release publish --version 0.4.4 --dry-run
basectl release publish --version 0.4.4 --yes
```
