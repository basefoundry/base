...
EOF
    ...
    [[ "$output" == *"Issue #53 was created, but Project metadata is incomplete."* ]]
    [[ "$output" == *"Project field update failed. Set fields manually or resume the metadata update with:"* ]]
